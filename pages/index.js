...
const MINT_DATE = "2023-04-12 20:00:00"
...
export default function Home() {
  ...
  const getData = async () =>{
  axios.get('https://api-easyzoom.onrender.com/')
        .then(response => {
              ...
              <div className="black-bg rounded-2xl px-4 py-4 md:px-8 md:py-8">
                <div className="flex flex-col items-center pb-8 w-full">
                  <h3 className="font-poppins tracking-widest text-xl main-pink mt-2">
                    <span className="text-white px-8 py-3 uppercase"><b>Easyzoom Mint - Phase 2</b></span>
                  </h3>
                </div>
                {wallet && (
                  <button
